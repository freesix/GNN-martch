...
train_arg.add_argument("--train_iter", type=int, default=1, help="训练轮次")
train_arg.add_argument("--log_base", type=str, default='./log/', help="log的路径")
train_arg.add_argument("--val_intv", type=int, default=1, help="验证的间隔")
train_arg.add_argument("--save_intv", type=int, default=1, help="断点保存的间隔")
train_arg.add_argument("--log_intv", type=int, default=1, help="记录损失的轮次间隔的间隔")
