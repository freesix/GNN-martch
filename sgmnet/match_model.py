...
class hybrid_block(nn.Module):
    ...
    def forward(self,desc1,desc2,seed_index1,seed_index2):
        ...
        confidence1=torch.sigmoid(torch.diagonal(seed_weight1,dim1=1,dim2=2).squeeze(-1))
        confidence2=torch.sigmoid(torch.diagonal(seed_weight2,dim1=1,dim2=2).squeeze(-1))
